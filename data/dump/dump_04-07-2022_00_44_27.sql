...
COPY public.transaction_details (id, amount, transaction_type, credit_id, from_account_id, to_account_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.exc_rate_seq_id', 1, false);
